...
=C-c v i= opens =*grove-inbox*=, a triage buffer that lists notes needing attention. The buffer groups notes by the enabled =grove-inbox-review-checks=: =untagged=, =no-backlinks=, and/or =in-inbox=.
